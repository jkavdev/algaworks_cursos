package br.com.jkavdev.algaworks.javaee.aula405;
...
@ManagedBean(name = "funcionariosPaginacaoBean")
@ViewScoped
public class FuncionariosBean implements Serializable {
	...
	private void adicionarFuncionario() {
		...
		funcionarios.add(
				new Funcionario(getMatriculaAleatoria(), nomeCompleto, getDataAleatoria(), getSalarioAleatorio()));
	}
